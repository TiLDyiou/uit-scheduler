                          ...
                          >
                            <div className="flex items-center justify-between gap-3">
                              ...
                              <div className="flex items-center gap-1 shrink-0">
                                <button
                                  ...
                                  className="p-1.5 text-[var(--fg-comments)] hover:text-[var(--color-blue)] rounded-lg hover:bg-[var(--bg-storm)] transition-colors"
                            ...
                            <div className="mt-2 pt-2 border-t border-[var(--border-muted)]/50 flex items-center justify-between text-[11px]">
                              ...
                              <div className="flex items-center gap-1 shrink-0 ml-2">
                                ...
                                >
                                  {isPinned ? "Đổi lớp" : "Chọn lớp cụ thể"}
                                </button>
                              </div>
                            </div>
                          </div>
                              ...
                              <button
                                ...
                                className={`p-1.5 rounded-lg transition-colors ${
                                  isPinned
                                    ...
                                    : "text-[var(--fg-comments)] hover:text-[var(--fg-editor)] hover:bg-[var(--bg-storm)]"
                                }`}
                                title="Xem và chọn cụ thể mã lớp"
                              >
                                <Eye className="w-4 h-4" />
